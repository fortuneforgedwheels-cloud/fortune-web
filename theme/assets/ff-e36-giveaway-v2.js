...
(function () {
  ...
  var ATTR_TICKET_COUNT = 'Giveaway ticket count';
  var ATTR_TICKET_IDS = 'Giveaway ticket IDs';
  ...
  function currentEntryQty(root) {
    var input = qs(root, '[data-ff-e36-qty-input]');

...
(function () {
  ...
  function canStageFromForm(form) {
    ...
    // Timeline / intent are optional in older form variants; when present they must be complete.
    var timelineInputs = form.querySelectorAll('input[name="ff_timeline"]');
    if (timelineInputs.length) {
